...
def get_habits(
    ...
    habits = service.get_habits(user_id, type, status)
    return habits
...
def create_habit(
    ...
    """Create a new habit"""
    try:
        created_habit = service.create_habit(user_id, habit)
...
def update_habit(
    ...
    """Update a habit"""
    updated_habit = service.update_habit(habit_id, user_id, habit)
...
def delete_habit(
    ...
    """Delete a habit"""
    success = service.delete_habit(habit_id, user_id)
    if not success:
        raise HTTPException(status_code=404, detail="Habit not found")
    return None
...
def create_habit_input(
    ...
    try:
        created_input = service.create_habit_input(user_id, habit_input)
...
def get_habit_inputs(
    ...
    inputs = service.get_habit_inputs(user_id, habit_id)
    return inputs
...
def chat_with_llm(
    ...
    try:
        service.create_habit_input(user_id, habit_input)
    except Exception as e:
